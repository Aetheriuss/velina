...
<div class="row mt-4">
    <div class="col-12">
        ...
        <div class="col-12 mt-4">
            <h3>Quick Config</h3>
            <button class="btn btn-primary mt-4" on:click={() => {
                const permissions = ['GetStats','GetAlert','SetAlert','CreateUser','GetPendingGroupIcons','GetAssetModerationDetails','GetPendingModerationItems','GetPendingModerationGameIcons','SetGameIconModerationStatus','SetAssetModerationStatus','SetGroupIconModerationStatus','GetGroupManageInfo','GetUserJoinCount','GetUsersList','GetUserDetailed','UnbanUser','BanUser', 'GetUserModerationHistory', 'CreateMessage','GetAdminMessages','NullifyPassword','DestroyAllSessionsForUser','LockAccount','RegenerateAvatar','ResetAvatar','GetAdminLogs','GetUserBadges','GiveUserBadge','DeleteUserBadge','GiveUserRobux','GetUserCollectibles','RemoveUserItem','TrackItem','GiveUserItem','DeleteUser','GetPreviousUsernames','DeleteUsername','DeleteComment','RequestAssetReRender','GetProductDetails','SetAssetProduct','CreateAsset','CreateClothingAsset','CreateAssetVersion','MigrateAssetFromRoblox','CreateGameForUser','RequestWebsiteUpdate','RunLottery','GetUserStatusHistory','DeleteUserStatus','GetUserCommentHistory','ManageFeatureFlags','GetUsersOnline','GetUsersInGame','GetUserTransactions','ResetUsername','ResetDescription','GetGroupWall','DeleteGroupWallPost','GetAllAssetComments','GetAllUserStatuses','LockAndUnlockGroup','GetGroupStatus','DeleteGroupStatus','ResetGroup','ManageReports','GetAllAssetOwners','GetDetailsFromThumbnail','SetPermissions','GetGameServers','MakeItemLimited','CreateBundleCopiedFromRoblox','GetSaleHistoryForAsset','RefundAndDeleteFirstPartyAssetSale', 'ChangeUsername'];
            ...
            <button class="btn btn-primary mt-4 ml-2" on:click={() => {
                const permissions = ['GetStats', 'GetAllAssetComments', 'DeleteComment', 'GetGroupWall', 'DeleteGroupWallPost', 'GetGroupStatus', 'DeleteGroupStatus', 'GetAllUserStatuses', 'DeleteUserStatus'];
